...
public class AnnuallyYieldController {
    ...
    public AnnuallyYieldController( Create< AnnuallyYield > createAnnuallyYield, Update< AnnuallyYield > updateAnnuallyYieldYield, Delete< AnnuallyYield > deleteAnnuallyYield, AnnuallyYieldRepository annuallyYieldRepository, DataStorageHandler dataStorageHandler, Request request ) {
